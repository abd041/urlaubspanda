  ...
  return (
    <motion.button
      ...
      className={cn(
        ...
        selected
          ? "border-brand-500 bg-brand-500 text-white shadow-[0_2px_10px_rgba(27,99,235,0.18)]"
    ...
    >
      <Icon
        className={cn(
          ...
          selected ? "text-white" : filterIconColor[icon]
        )}
        strokeWidth={1.6}
        aria-hidden="true"
      />
      <span
        className={cn(
          "line-clamp-2 max-w-full text-[11px] font-medium leading-tight tracking-tight",
